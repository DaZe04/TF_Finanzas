<template>
  <div class="client-view">
    ...
    <button @click="openFormModal()" class="add-button">Nuevo Cliente</button>
    ...
    <!-- Tabla para mostrar los clientes (se muestra cuando la carga ha terminado) -->
    ...
    <!-- Paginación -->
    <!-- Solo mostrar paginación si no está cargando y hay más de una página -->
...
const fetchClients = async () => {
  ...
  onSnapshot(clientsCollection, (querySnapshot) => {
    ...
    isLoading.value = false; // Desactivar el estado de carga una vez que llegan los datos
  });
};
